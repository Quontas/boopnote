...
public class DropNote extends NoteUI {
    ...
    protected Button mBackButton;   //Go back -- Contrasts wholly with the design, ordinarily, the back-button at the bottom of the screen is used
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBackButton = (Button) findViewById(R.id.backButton);   //Really considering removing this
        mBackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                back(view);
            }
        }); //If tapped, should take the user back to NoteUI.class
    ...
    /**
     * This doesn't work and I'm seriously considering deleting it.
     * @param view
     */
    public void back(View view) {
        Intent intent = new Intent(this, NoteUI.class);
